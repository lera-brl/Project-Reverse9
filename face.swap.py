...
# Пути к файлам
source_img_path = "InteractiveMirror9/girl.jpg"        # лицо девочки
target_img_path = "InteractiveMirror9/angryface.png"   # иллюстрация
...
if target_img is None:
    print("Ошибка: не удалось загрузить angryface.png")
elif source_img is None:
    print("Ошибка: не удалось загрузить girl.jpg")
else:
    # Обнаружение лиц
